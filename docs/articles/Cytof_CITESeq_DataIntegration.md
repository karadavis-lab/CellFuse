...
As shown in Data Preparation vignette we splitted reference data in to
training and validation subsets. Now let’s train CellFuse model using
reference data (CyTOF)
...
```
    ...
    ## Loading the model: /private/var/folders/31/95qcf9qd5xd8jlgntfp59yjr0000gp/T/RtmpaGFVLq/temp_libpath1611624d0290b/CellFuse/extdata/Cytof_CITESeq/Predicted_Data/Saved_model/Levine32_2025-11-24.pt
...
![](Cytof_CITESeq_DataIntegration_files/figure-html/tsne-visualization-1.png)
